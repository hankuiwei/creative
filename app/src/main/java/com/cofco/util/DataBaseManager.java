...
public class DataBaseManager {
	...
	/**
	 * 插入数据
	 * @param sql  		执行更新<strong>操作</strong>的sql语句
	...
	/**
	 * 查询数据
	 * @param searchSQL 		执行查询<strong>操作</strong>的sql语句
	 * @param selectionArgs		查询条件
	 * @return 					返回查询的游标，可对数据自行<strong>操作</strong>，需要自己关闭游标
	 */
	...
	/**
	 * 查询数据
	 * @param sql				执行查询<strong>操作</strong>的sql语句	
	 * @param selectionArgs		查询条件
